...
import com.cg.ata.project.service.UserService;
...
public class UserController {
	...
	// http://localhost:9999/user/view-all-vehicle
	...
	public ResponseEntity<List<User>> getAlluser() {
		...
		ResponseEntity<List<User>> response = new ResponseEntity<>(userList, status);
		return response;
	}
...
//	public ResponseEntity<> getEmpById(@PathVariable(name = "eid") int eid) {
...
//		ResponseEntity<User> response = new ResponseEntity<>(userService.addUser(user), status);
//		return response;
}
//
